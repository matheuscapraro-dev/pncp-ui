...
import type { CompraPublicacaoDTO, ContratoDTO, AtaRegistroPrecoDTO, SituacaoCompraId } from "@/types/pncp";
...
function SrpBadge({ srp }: { srp: boolean }) {
  if (!srp) return null;
  return (
    <Badge variant="outline" className="gap-1 border-blue-500/40 bg-blue-50 text-blue-700 dark:border-blue-500/30 dark:bg-blue-950/40 dark:text-blue-400">
...
function CanceladoBadge({ cancelado }: { cancelado: boolean }) {
  return (
    <Badge variant="outline" className={`gap-1 font-medium ${cancelado
      ? "border-red-500/40 bg-red-50 text-red-700 dark:border-red-500/30 dark:bg-red-950/40 dark:text-red-400"
      : "border-emerald-500/40 bg-emerald-50 text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-950/40 dark:text-emerald-400"
    }`}>
